...
public class Dashboard extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId()== R.id.dashboard_btn_change_pass)
        {
            ...
            if(input_new_password.getText().toString().length() == 0 ) {
            input_new_password.setError( "Email is required!" );}
            else{
    ...
    public void onBackPressed() {
        ...
        Snackbar snackbar = Snackbar.make(activity_dashboard , "Logout First" ,Snackbar.LENGTH_SHORT );
        snackbar.show();
